    ...
    return (
        <Fragment>
            <div
                ...
                onClick={() => {
                    props.setModalState(true); props.getPropertyInfo(props.mainData.property_id);
                }}
                data-toggle="modal"
                    ...
                    <div className="ps-3">
                        <div className="d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                {moment(props.data?.created_at).format('DD/MM/yyyy, h:mm a')}</div>
                        </div>
                        <div className="mt-1">
            ...
            >
                ...
                <div className="modal-body">
                        ...
                        <Col md={8}>
                            <Row className="d-flex py-2">
                                ...
                                <Col md={6}>
                                    ...
                                    <span className="text-primary ms-1">{props.property_info_data?.data?.data?.reference}</span>
                                </Col>
                            </Row>
                            <Row className="py-1">
                                <Col md={6}>
                                    ...
                                    <span className="ms-2"> {props.data?.subject}</span>
                                </Col>
                                <Col md={6}>
                    ...
                    <div style={{ backgroundColor: "#f7f7f7", padding: "20px" }}>
                        ...
                        >
                            {
                                props.message?.watch == 1 ?
                                    <div className="d-flex align-items-center ps-4"
                                        style={{ height: "70px", backgroundColor: "#e3efbe" }}>
                                        <i className="fas fa-eye" style={{ color: '#3c763d' }} />
                                        <div className="ms-2">
                                            Opened: {moment(props.message.updated_at).format('DD/MM/yyyy h:mm a')}
                                        </div>
                                    </div>
                                    :
                                    <div
...
const mapStateToProps = gstate => {
    ...
    return {
        send_email_data,
        send_email_error,
        send_email_loading, property_info_data, property_info_loading
    };
};
export default withRouter(
    connect(mapStateToProps, {
        sendEmail,
        sendEmailFresh, getPropertyInfo
    })(MailTemplateModal)
);
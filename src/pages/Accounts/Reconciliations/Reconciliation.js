...
import {
  ...
  RevokeReconciliationFresh,
  UnreconciledDepositsDataFresh,
...
function Reconciliation(props) {
  ...
  useEffect(() => {
    ...
    props.bank_statement_edit_loading,
    props.reconcile_store_loading,
    props.approve_reconciliation_loading,
    props.revoke_reconciliation_loading,
  ]);
          ...
          <Col lg={12}>
            <div>
                    ...
                    <Row>
                      <Col md={12}>
                        <h4 className="text-primary">
                          ...
                          Reconciliation{" "}
                          {moment(state?.date).format("MMMM").toString() ===
                            moment().format("MMMM").toString() && (
                            <>(current)</>
                          )}
                        </h4>
                      </Col>
                    ...
                    <Row className="py-2">
                      <Col md={6}>
                        <div className="button-items d-flex">
                          ...
                          >
                            ...
                            <DropdownMenu>
                              <DropdownItem>
                                <Link
                                  style={{ color: "black" }}
                                  to={`/reconciliationReport/${state?.id}`}
                                  target="blank"
                                >
                                  Reconciliation
                                </Link>
                              ...
                              <DropdownItem>
                                ...
                                <Link
                                  style={{ color: "black" }}
                                  to={`/unreconcileItems/${state?.date}/${state?.id}`}
                                  target="blank"
                                >
                                  Unreconciled Items
                                </Link>
                              ...
                              <DropdownItem>
                                <Link
                                  style={{ color: "black" }}
                                  to={`/folioLedger/${state?.year}/${state?.month}/${state?.day}`}
                                  target="blank"
                                >
                                  Folio Ledger
                                </Link>
                              ...
                              <DropdownItem>
                                <Link
                                  style={{ color: "black" }}
                                  to={`/trialBalance/${state?.year}/${state?.month}/${state?.day}`}
                                  target="blank"
                                >
                                  Trial Balance
                                </Link>
                              ...
                              <DropdownItem>
                                <Link
                                  style={{ color: "black" }}
                                  to={`/transactionAuditReport/${state?.year}/${state?.month}`}
                                  target="blank"
                                >
                                  Transaction audit
                                </Link>
                              ...
                              <DropdownItem>
                                <Link
                                  style={{ color: "black" }}
                                  to={`/cashBookReport/${state?.year}/${state?.month}`}
                                  target="blank"
                                >
                                  Cash Book
                                </Link>
                              ...
                              <DropdownItem>
                                <Link
                                  style={{ color: "black" }}
                                  to={`/journalsReport/${state?.year}/${state?.month}`}
                                  target="blank"
                                >
                                  Journals
                                </Link>
                          ...
                          {/* } */}
                          {reconciledBankStatementBalance === cashBookBalance &&
                          reconciledBankStatementBalance === folioBalance &&
                          data?.reconcilliation_month?.reconciliation_status ===
                            "approve" ? (
                            <button
                              type="button"
                        ...
                        {reconciledBankStatementBalance === cashBookBalance &&
                          reconciledBankStatementBalance === folioBalance && (
                            <div className="bg-success px-5 py-3">
                              <i className="fas fa-balance-scale me-2 font-size-20" />{" "}
                              Reconciled
                            </div>
                          )}
              ...
              <Card>
                <CardBody>
                  <div>
                    <h4 className="text-primary">Bank Account</h4>
                  </div>
                  <Row className="py-1">
                    <Col md={6}>
                      <div className="d-flex">
                        <BankStatementModal
                          ...
                          setState={setState}
                          toggle={toggleModal}
                          id={props.recon_data?.data?.r_month_id}
                          balance={data?.bank_statement_balance}
                          date={data?.bank_statement_balance_date}
                          reconciliation_id={state?.id}
                    ...
                    <Col md={6} className="d-flex justify-content-end">
                      <div>
                        <b>${data?.bank_statement_balance}</b>
                      </div>
                    </Col>
                  </Row>
                  <Row className="py-1">
                    ...
                    <Col md={6} className="d-flex justify-content-end">
                      <Row className="w-100 fw-bold">
                        <Col
                          md={6}
                          className="d-flex justify-content-end font-size-18"
                        >
                          +
                        </Col>
                        <Col md={6} className="d-flex justify-content-end">
                  ...
                  <Row className="py-1">
                    ...
                    <Col md={6} className="d-flex justify-content-end">
                      <Row className="w-100 fw-bold">
                        ...
                        <Col
                          md={6}
                          className="d-flex justify-content-end border-bottom border-secondary"
                        >
                          ${data?.withdrawals_not_processed}
                        </Col>
                      </Row>
                    </Col>
                  </Row>
              ...
              <Card>
                <CardBody>
                  <div>
                    <h4 className="text-primary">Cashbook </h4>
                  </div>
                  ...
                  <Row className="py-1">
                    <Col md={6}>
                      ...
                      <b>
                        {moment().subtract(1, "months").format("01, MMMM YYYY")}
                      </b>{" "}
                    </Col>
                    <Col
                      md={6}
                  ...
                  <Row className="py-1">
                    <Col md={6}>
                      Add:{" "}
                      <Link to={`/receiptsList/${state?.date}`}>
                        new receipts
                      </Link>
                    </Col>
                    <Col md={6} className="d-flex justify-content-end">
                  ...
                  <Row className="py-1">
                    <Col md={6}>
                      Less:{" "}
                      <Link to={`/withDrawals/${state?.month}/${state?.year}`}>
                        new withdrawals
                      </Link>
                    </Col>
                    <Col md={6} className="d-flex justify-content-end">
                  ...
                  <Row className="py-1">
                    <Col md={6}>
                      ...
                      <div>
                        Balance as at 1 {moment().format("DD, MMMM YYYY")}{" "}
                      </div>
                    </Col>
                    <Col md={6} className="d-flex justify-content-end">
                      <div className="fw-bold">
                        ${cashBookBalance > 0 ? cashBookBalance : "0.00"}
                      </div>
                    </Col>
                  </Row>
                </CardBody>
              ...
              <Card>
                <CardBody>
                  <div>
                    <h4 className="text-primary">Folio Balances</h4>
                  </div>
                  <Row className="py-1">
                    <Col md={6}>
                      Folio balances as at{" "}
                      <b>{moment().format("DD, MMMM YYYY")}</b>
                    </Col>
                    <Col md={6} className="d-flex justify-content-end">
                      <div className="fw-bold">
                        ${folioBalance > 0 ? folioBalance : "0.00"}
                      </div>
                    </Col>
                  </Row>
                </CardBody>

...
function ReconciliationsList(props) {
  ...
  const titleRef = (cell, row) => (
    <span className="text-primary">{moment(cell).format("MMMM YYYY")}</span>
  );
    ...
    if (
      ...
      return (
        <span className="text-success">
          <i className="fas fa-check"></i> Approved and Closed
        </span>
      );
    }
  ...
  const activeData = [
    {
      ...
      events: {
        onClick: (e, column, columnIndex, row, rowIndex) => {
          titleDetail(e, column, columnIndex, row, rowIndex);
        },
      },
    },
    {
                          ...
                          >
                            ...
                            <div className="d-flex flex-column justify-content-center mx-2 py-1 px-3">
                              <span style={{ fontSize: "22px" }}>
                                {props.recon_list_data?.totalWithdraw
                                  ? props.recon_list_data?.totalWithdraw
                                  : 0}
                              </span>
                      ...
                      <Row className="py-2">
                        <Col md={9} className="">
                          <div className="button-items">
                            ...
                            >
                              Reconcile{" "}
                              <i className="fas fa-angle-right ms-2" />
                            </button>
                          </div>
                        </Col>
                        <Col md={3}>

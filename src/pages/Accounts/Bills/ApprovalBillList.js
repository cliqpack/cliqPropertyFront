...
import {
  approveMultipleBill,
  approveMultipleBillFresh,
  billApprovalList,
  billApprovalListFresh,
  deleteBill,
  deleteBillAction,
...
const mapStateToProps = gstate => {
  const {
    ...
    approval_bills_list_data,
    approval_bills_list_error,
    approval_bills_list_loading,
    approve_bill_loading,
    approve_multiple_bill_loading,
  } = gstate.Bills;

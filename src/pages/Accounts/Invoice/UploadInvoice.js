...
function UploadInvoice(props) {
  ...
  useEffect(() => {
    ...
    props.uploaded_invoice_list_data_loading,
    props.add_bills_tenant_invoice_loading,
    props.edit_invoice_loading,
    props.delete_invoices_loading,
  ]);
  ...
  const formatRef = (cell, row) => {
    return (
      <button
        ...
        onClick={() => billDetails(row)}
      >
        Process <i className="fas fa-arrow-right"></i>
      </button>
    );
  };
  ...
  return (
    <div className="page-content">
      ...
      {showEditInvoiceModal && (
        <AddInvoiceModal
          showModal={showEditInvoiceModal}
                          ...
                          >
                            ...
                            <div className="d-flex flex-column justify-content-center mx-2 py-1 px-3">
                              <span style={{ fontSize: "22px" }}>
                                {props.uploaded_invoice_list_data?.data?.length}
                              </span>
                              <span>Invoices</span>
                            </div>
                      ...
                      <Row style={{ height: "88px" }}>
                        <Col md={9} className="d-flex align-items-end">
                          <div className="button-items">
                            ...
                            <button
                              type="button"
                              disabled={invoiceIds.length > 0 ? false : true}
                    ...
                    <Col sm="12">
                      <CardText className="mb-0">
                        ...
                        <PaginationProvider
                          ...
                          data={
                            props.uploaded_invoice_list_data
                              ? props.uploaded_invoice_list_data.data
                              : []
                          }
                        >
...
const mapStateToProps = gstate => {
  ...
  const { add_bills_tenant_invoice_loading } = gstate.Bills;
  return {
    uploaded_invoice_list_data,
    uploaded_invoice_list_data_loading,

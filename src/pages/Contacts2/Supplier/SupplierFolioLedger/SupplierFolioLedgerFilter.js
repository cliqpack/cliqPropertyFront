...
import SupplierFilterDynamicReport from "./SupplierFilterDynamicReport";
import ReactSelectComp from "components/FormComponent/Select/ReactSelectComp";
import moment from "moment";
import "flatpickr/dist/themes/material_blue.css"
import Flatpickr from "react-flatpickr"

function SupplierFolioLedgerFilter(props) {
    ...
    const handleFilterFunction = () => {
        props.startLoader()
        props.FilterSupplierFolioLedgerReportApi(props.id, state)
    }
    ...
    return <SupplierFilterDynamicReport downloadButtons={downloadButtons} rightSideButtons={rightSideButtons} handleFilterFunction={handleFilterFunction}>
    ...
    </SupplierFilterDynamicReport>
}

export default SupplierFolioLedgerFilter
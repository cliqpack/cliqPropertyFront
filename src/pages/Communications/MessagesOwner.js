...
const Messages = props => {
  ...
  // const inboxSubjectRef = (cell, row) => (<span style={row.watch == 1 && row.reply_to == authUser.user.email ? { fontWeight: 'bold', color: "#3477eb" } : { fontWeight: 'normal', color: "#3477eb" }}>{row.subject}</span>);
  ...
  const dateRef = (cell, row) => (
    <span className="text-muted">{moment(cell).format("DD/MM/yyyy")}</span>
  );
  ...
  useEffect(() => {
    ...
    sendReply,
    props.outbox_list_owner_loading,
  ]);
  console.log(props.tmp_list_data?.template);
              ...
              <Card className="email-leftbar">
                ...
                >
                  <Button id="caret" color="danger">
                    <i className="fas fa-edit me-1 font-size-16" /> New
                  </Button>
                  <DropdownToggle
                    caret
                    color="danger"
                  ...
                  <DropdownMenu>
                    <DropdownItem value="1">Compose</DropdownItem>
                    <DropdownItem value="2">SMS</DropdownItem>
                    <DropdownItem onClick={togglemodal}>Compose</DropdownItem>
                      ...
                      >
                        ...
                        <span className="ml-1 float-end">
                          ...
                          {props?.inbox_list_data?.data
                            ? props?.inbox_list_data?.data.length
                            : ""}
                      ...
                      >
                        ...
                        <span className="ml-1 float-end">
                          ...
                          {props.outbox_list_owner_data?.data
                            ? props.outbox_list_owner_data?.data.length
                            : ""}
                          )
                        </span>
                      </NavLink>
              ...
              <div className="email-rightbar mb-3">
                <Card>
                  <TabContent activeTab={state.activeTab}>
                    ...
                    <TabPane tabId="1">
                      <div className="px-2 mt-2">
                        {/* {console.log(props.outbox_list_owner_data)} */}
                        {props.outbox_list_owner_data?.data ? (
                          <DatatableTables2
                    ...
                    <TabPane tabId="6" className="py-5 px-2"></TabPane>
                    <TabPane tabId="7">
                      <PaginationProvider
...
const mapStateToProps = gstate => {
  const {
    ...
    inbox_list_owner_data,
    inbox_list_owner_loading,
    outbox_list_owner_data,
    outbox_list_owner_loading,
    mail_list_undelivered_owner_data,
  } = gstate.Message;
  return {
    mail_list_data,
    mail_list_error,

      ...
      <Modal isOpen={props.taskModal} toggle={props.toggle}>
        ...
        <ModalBody style={{ backgroundColor: "#F2F6FA" }}>
          <Form className="form p-3">
            ...
            <FormGroup row style={{ position: "relative", zIndex: "5" }}>
            ...
            <FormGroup row style={{ position: "relative", zIndex: "4" }}>
            ...
            <FormGroup row>
              <Label for="exampleSelect " className="form-group-new-desc-label" style={{ marginBottom: "-10px", zIndex: "3", width: "90px", padding: "0px 3px 0px 3px", }}>
                Description
              </Label>
              <Col sm={12}>

...
const MailTemplateModalProperty = props => {
  ...
  const [state, setState] = useState({
    ...
    body: props.data?.body ? props.data?.body : "",
  });
  ...
  //         : "",
  //     subject: props.data?.message?.subject
  //         ? props.data?.message?.subject
  //         : "",
  //     body: props.data?.message?.body
          ...
          <Row>
            <Col md={9}>
              <Row>
                ...
                <Col md={7}>
                  <span className="text-primary">{props.data?.to}</span>
                </Col>
                <Col md={4}>
                  {/* <span style={{ color: "#6e6e6e", fontWeight: "bold" }}>
                                        Property
                                    </span>{" "}
                                    <span className="text-primary">{moment(props.data?.created_at).format('DD/MM/yyyy')}</span> */}
                </Col>
                <Col md={1}>
                  <span style={{ color: "#6e6e6e", fontWeight: "bold" }}>
                    Subject:

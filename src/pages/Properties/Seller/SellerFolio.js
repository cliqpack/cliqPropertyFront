...
import SellerArchiveModal from "./SellerArchiveModal";
...
function SellerFolio(props) {
  ...
  const toggle = (tab, type = null) => {
    ...
    if (tab == "1") {
      ...
      props.PendingBillsForSeller(propertyId, fId);
    } else if (tab == "4") {
      props.PaidBillsForSeller(propertyId, fId);
    } else if (tab === "5") {
  ...
  const saleInfoData = props.seller_info_property_data?.data?.data;
  ...
  useEffect(() => {
    ...
    if (props.archive_seller_loading == "Success") {
      if (props.archive_seller_data?.status == 1) {
    ...
    props.transaction_list_id_seller_folio_loading,
  ...
  let moneyIn = saleInfoData?.sales_contact?.seller_folio?.money_in
    ...
    : 0;
  let moneyOut = saleInfoData?.sales_contact?.seller_folio?.money_out
    ? saleInfoData?.sales_contact?.seller_folio?.money_out
    : 0;
  ...
  return (
    <div className="page-content">
      ...
      <Container fluid={true}>
        <h4 className="text-primary py-2">Seller Folio</h4>
        <Row>
          <Col md={2}>
            <div>
                    ...
                    <Col md={12} className="d-flex flex-column">
                      <div className="mb-3">
                        <h4
                          ...
                          style={{ fontSize: "14px" }}
                        >
                          {saleInfoData?.sales_contact?.reference} Seller Folio{" "}
                          {saleInfoData?.sales_contact?.seller_folio?.folio_code
                            ? `${saleInfoData?.sales_contact?.seller_folio?.folio_code}`
                            : ""}
                        </h4>
                      </div>
                        ...
                        {saleInfoData?.status == "1" && (
                          ...
                          >
                            ...
                            <DropdownMenu>
                              ...
                              {saleInfoData?.has_buyer != "true" && <DropdownItem
                                onClick={() =>
                                  addbuyer(
                                    saleInfoData?.sales_contact?.id)
                                }
                    ...
                    <Alert color="info">
                      <div className="d-flex justify-content-between">
                        <span className="font-size-20">
                          ...
                          {moment(saleInfoData?.updated_at).format(
                            "DD MMM YYYY"
                          )}
                        </span>
                        <Button
                  ...
                  >
                    ...
                    <TabPane tabId="4">
                      <Row>
                        <Col sm="12">
                          <CardText className="mb-0">
                            {props.paid_bills_seller_folio_data ? (
                              <DatatableTables2
                                products={
                                  props.paid_bills_seller_folio_data || []
                                }
      ...
      {showModal && (
        <BillsInfoModal
          ...
          ownerId={null}
          supplierId={saleInfoData?.sales_contact?.id}
...
const mapStateToProps = gstate => {
  const {
    ...
    transaction_list_id_seller_folio_data,
    transaction_list_id_seller_folio_error,
    transaction_list_id_seller_folio_loading,

    pending_bills_seller_folio_data,
    pending_bills_seller_folio_error,
    pending_bills_seller_folio_loading,

    paid_bills_seller_folio_data,
    paid_bills_seller_folio_error,
    paid_bills_seller_folio_loading,

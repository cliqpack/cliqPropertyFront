...
import SellerFilterDynamicReport from "./SellerFilterDynamicReport";
import ReactSelectComp from "components/FormComponent/Select/ReactSelectComp";
import moment from "moment";
import "flatpickr/dist/themes/material_blue.css"
import Flatpickr from "react-flatpickr"

function SellerFolioLedgerFilter(props) {
    ...
    const handleFilterFunction = () => {
        props.startLoader()
        props.FilterSellerFolioLedgerReportApi(props.id, state)
    }
    ...
    return <SellerFilterDynamicReport downloadButtons={downloadButtons} rightSideButtons={rightSideButtons} handleFilterFunction={handleFilterFunction}>
    ...
    </SellerFilterDynamicReport>
}

export default SellerFolioLedgerFilter
...
import {
  FilterOwnerFolioLedgerReportApi,
  FilterOwnerFolioLedgerReportApiFresh,
  ownerFolioLedgerReport,
  storeAttachmentForSendInEmail,
} from "store/actions";
    ...
    <React.Fragment>
      <div>
        <InvoiceHeader
          ...
          sendDocumentInEmail={sendDocumentInEmail}
        />
        <OwnerFolioLedgerFilter
          startLoader={startLoader}
          id={id}
          FilterOwnerFolioLedgerReportApi={
            props.FilterOwnerFolioLedgerReportApi
          }
        />
                  ...
                  <div>
                    ...
                    <div className="table-responsive">
                      <Table className="table mb-0">
                        ...
                        <tbody>
                          {props.owner_fl_data?.data?.folio_ledger?.length >
                            0 && (
                            <tr>
                              <td colSpan="12">
                                <span className="fw-bold font-size-16">
                                  {
                                    props.owner_fl_data?.data?.owner_contacts
                                      ?.reference
                                  }{" "}
                          ...
                          {props.owner_fl_data?.data?.folio_ledger.map(
                            (item2, index2) => {
                              let balance = parseInt(
                                item2?.opening_balance
                                  ? item2?.opening_balance
                                  : 0
                              );
                              let creditTotal;
                              ...
                              return (
                                <>
                                  ...
                                  {item2?.ledger_details_daily?.map(
                                    (item3, index3) => {
                                      creditTotal = item2?.ledger_details_daily
                                      ...
                                      debitTotal = item2?.ledger_details_daily

...
import {
  getOwnerPropertyFeeList,
  getOwnerPropertyFeeListFresh,
  getOwnerShipFees,
} from "store/actions";
...
const NewPropertyFeeForm = props => {
  ...
  const handleChangeInput2 = async (mainIdx, idx, e, type) => {
    ...
    values[mainIdx]["data"][idx]["income_account"] = `${e.account_name}(${
  ...
  useEffect(() => {
    if (props.get_owner_property_fee_list_loading === "Success") {
      ...
      if (
        props.get_owner_property_fee_list_data?.data?.propertyWiseFee?.length >
        0
      ) {
          ...
          {items.data.map((item, idx) => (
            <Row id={"addr" + idx} key={idx}>
              <Col lg="2" className="mb-3">
                ...
                <div>
                  <div className="mb-3 select2-container">
                    <Select
                      value={
                        props.state7[mainIdx]["data"][idx]["selectedValues"]
                      }
                      onChange={e =>
                        handleChangeInput2(mainIdx, idx, e, "fee_template")
                      }
              ...
              <Col lg="2" className="mb-3">
                ...
                <p>{props.state7[mainIdx]["data"][idx]["income_account"]}</p>
              </Col>

              <Col lg="2" className="mb-3">
                <label htmlFor="fee_trigger">Fee trigger</label>

                <p>{props.state7[mainIdx]["data"][idx]["fee_trigger"]}</p>
              </Col>
                ...
                <Row>
                  <Col className="d-flex justify-content-center align-items-center">
                    ...
                    <input
                      name="amount"
                      type="text"
                      value={props.state7[mainIdx]["data"][idx]["amount"]}
                      ...
                      onChange={e => handlePropertyFormValues7(mainIdx, idx, e)}
                    />
                    {props.state7[mainIdx]["data"][idx].types == "%" && (
              ...
              >
                <Button
                  onClick={e => handleRemoveRow7(e, idx, mainIdx)}
                  color="danger"
                >
                  Remove
                </Button>

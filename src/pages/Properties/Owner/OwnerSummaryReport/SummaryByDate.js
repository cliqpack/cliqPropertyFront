                    ...
                    <Card>
                        <CardBody>
                            <div className="d-flex justify-content-between">
                                <img
                                    src={process.env.REACT_APP_IMAGE + props.summary_transaction_by_date?.brandSettingLogo?.brand_image}
                                    style={{
                                        height: `${props.summary_transaction_by_date?.brandSettingStatement?.header_height_by_millimeter}mm`,
                                        width: 'auto',
                                        maxHeight: '50mm',
                                        minHeight: '5mm',
                                        margin: '40px'
                                    }} alt={props.summary_transaction_by_date?.brandSettingLogo?.image_name}
                                />
                                <div className="p-4">
                                    <p>(w) 9999 3333</p>
                                    <p>demo@myday.com</p>

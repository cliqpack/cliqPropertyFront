...
const EditPropertyFeeForm = props => {
  ...
  const handleChangeInput2 = async (idx, e, type) => {
    ...
    values[idx]["income_account"] = `${e.account_name}(${
      e.account_tax === 1 ? "inc. tax" : "Ex. tax"
    })`;
  ...
  return (
    <Card>
      <CardBody>
        <CardTitle className="text-primary mb-4">{props.propertyRef}</CardTitle>
        {props.rows4.map((item, idx) => (
          <Row id={"addr" + idx} key={idx}>
            <Col lg="2" className="mb-3">
              <label htmlFor="fee_template">Fee template</label>
              <div>
                <div className="mb-3 select2-container">
                  <Select
                    value={props.state7[idx]["selectedValues"]}
                    onChange={e => handleChangeInput2(idx, e, "fee_template")}
            ...
            <Col lg="2" className="mb-3">
              ...
              <p>{props.state7[idx]["income_account"]}</p>
            </Col>

            <Col lg="2" className="mb-3">
              <label htmlFor="fee_trigger">Fee trigger</label>

              <p>{props.state7[idx]["fee_trigger"]}</p>
            </Col>
            ...
            <Col lg="2" className="mb-3 d-flex flex-column align-items-center">
              ...
              <Row>
                <Col className="d-flex justify-content-center align-items-center">
                  ...
                  <input
                    name="amount"
                    type="text"
                    value={props.state7[idx]["amount"]}
                    className="form-control w-50"
                    style={{
                      borderTopLeftRadius:
                        props.state7[idx].types == "$" ? 0 : 5,
                    ...
                    onChange={e => handlePropertyFormValues7(idx, e)}
                  />
                  {props.state7[idx].types == "%" && (
            ...
            >
              <Button onClick={e => handleRemoveRow7(e, idx)} color="danger">
                Remove
              </Button>
            </Col>
        ...
        <div className="d-flex justify-content-end">
          {" "}
          <Button onClick={handleAddRow7} color="info" className="mt-3 mt-lg-0">
            Add{" "}
          </Button>{" "}
        </div>
      </CardBody>

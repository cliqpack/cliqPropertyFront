...
import { sellerFolioList } from 'store/actions'
...
const SaleAgreement = props => {
  ...
  useEffect(() => {
    ...
    if (props.seller_add_loading === "Failed") {
      toastr.error("Something went wrong");
      props.addSaleAgreementFresh();
    }
    if (props.seller_info_property_loading === "Success") {
      props.SaleAgreementInfoForProperty(id);
    }
  ...
  return (
    <div className="page-content">
      <div className="wizard clearfix">
        {/* <Breadcrumbs title="Add Sale Agreement" breadcrumbItem="Properties" /> */}
        <h4 className="text-primary py-2">Add Sale Agreement</h4>
        <Row className="g-2">
          <Col lg="2">
            <Card>
              <CardBody>
                <h4 className="ms-2 text-primary">
                  New Sale Agreement - {propertyRef || ""}
                </h4>
                <div
                  className="my-3"
                  style={{
...
export default withRouter(
  connect(mapStateToProps, {
    ...
    SaleAgreementInfoForProperty,
    SaleAgreementInfoFresh,
    editSaleAgreementInfoFresh, sellerFolioList
  })(SaleAgreement)
);

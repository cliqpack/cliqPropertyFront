...
import {
    providerSettingsListById, addProviderSettings, addProviderSettingsFresh, integrationsList,
...
export default function AddProvider() {
    ...
    const { providerSettingsListIDData,
        ...
        addProviderSettingsListIDLoading, deleteProviderSettingsListIDLoading, addProviderSettingsLoading } = useSelector(state => state.Portfolio);
    console.log(addProviderSettingsLoading);
    ...
    useEffect(() => {
        if (addProviderSettingsLoading == 'Success') {
            toastr.success('Success');
            dispatch(addProviderSettingsFresh())
            dispatch(integrationsList())
            history.push('/integrations')
        }
    }, [addProviderSettingsLoading])
    ...
    const handleSave = (e) => {
        ...
        if (state.agent.length < 6) {
            ...
            dispatch(addProviderSettings(state))
        }
    }

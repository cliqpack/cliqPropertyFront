...
function TransactionAuditFilter(props) {
    ...
    const handleFilterFunction = () => {
        props.startLoader()
        props.FilterCashBookReportApi(state)
    }
    ...
    return <FilterDynamicReport downloadButtons={downloadButtons} rightSideButtons={rightSideButtons} handleFilterFunction={handleFilterFunction}>
        <Col md={3}>
            <ReactSelectComp name={'By'} value={state.filterBy} options={state.optionsFilterBy} handler={handleFilterBy} />
        </Col>
        <Col md={3}>
            <ReactSelectComp name={'On'} value={state.transactionOn} options={state.optionsTransactionOn} handler={handleTransactionOn} />
        </Col>
        <Col md={2}>
